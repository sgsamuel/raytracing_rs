...
fn main() {
    ...
    let material_right  = Rc::new(Metal::new(Color::new(0.8, 0.6, 0.2), 0.2));

    world.add(Rc::new(Sphere::new(Point3::new(0.0,-100.5,-1.0), 100.0, material_ground)));
    world.add(Rc::new(Sphere::new(Point3::new(0.0,0.0,-1.2), 0.5, material_left)));
    world.add(Rc::new(Sphere::new(Point3::new(-1.0,0.0,-1.0), 0.5, material_center)));
